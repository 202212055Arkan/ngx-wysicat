...
export class DocumentSettingsGeneralService {
  ...
  private applyStyles(settings: DocumentSettings): void {
    ...
    document.documentElement.style.setProperty('--nw-editor-max-width-percent', `${settings.maxWidthPercent}`);
    document.documentElement.style.setProperty('--nw-editor-line-spacing-multiplier', `${settings.lineSpacingMultiplier}`);
  }
