...
import { LinkTestComponent } from './web-elements/link-test.component';
...
export class QuillCreatorService {
  ...
  registerWebComponent() {
    const component = createCustomElement(LinkTestComponent, { injector: this.injector });
