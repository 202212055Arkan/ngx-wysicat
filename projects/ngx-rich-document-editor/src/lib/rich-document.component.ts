...
import { RichDocumentService } from './rich-document.service';
import { QuillStore } from './store';

@Component({
  selector: 'rde-rich-document',
  templateUrl: './rich-document.component.html',
  imports: [CdkScrollable],
  styleUrls: ['./rich-document.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class RichDocumentComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  protected readonly richDocumentService = inject(RichDocumentService);
  ...
  ngAfterViewInit(): void {
    try {
      ...
      console.error('Failed to initialize rde-rich-document component:', error);
    }
  }
