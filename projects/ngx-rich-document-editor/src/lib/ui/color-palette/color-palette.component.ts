...
@Component({
  selector: 'rde-color-palette',
  templateUrl: './color-palette.component.html',
  styleUrl: './color-palette.component.scss',
  imports: [KeyValuePipe, SvgIconComponent],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ColorPaletteComponent {

  public label = input<'text' | 'background'>('text');

  public readonly colorChange = output<string | null>();
  protected colors: any = {
    red: {
      '050': 'oklch(0.971 0.013 17.38)',
    ...
    white: {
      '000': 'oklch(1.0 0.0 0.0)',
    },
    black: {
      '000': 'oklch(0.0 0.0 0.0)',
    },
  };
  colorEntries: any = Object.entries(this.colors).map(([key, value]) => ({key, value}));

  selectColor(color: any): void {
    this.colorChange.emit(color);
  }

  xd($event: MouseEvent | KeyboardEvent) {
